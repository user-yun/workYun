<template>
  <div>
    <el-row class="treeSearch">
      <el-col :span="20">
        <el-input v-model="filterText" clearable :maxlength="20" :placeholder="language.searchDev"></el-input>
      </el-col>
      <el-col :span="4">
        <mi icon="el-icon-refresh-left" @click="getRequest" :tooltip="language.refreshDev"></mi>
      </el-col>
    </el-row>
    <el-tree
      ref="deviceTree"
